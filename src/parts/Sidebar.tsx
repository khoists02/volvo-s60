...
const Sidebar: FC = () => {
  ...
  const [collapsed, setCollapsed] = useState(
    window.innerWidth > 1800 ? false : true,
  );
  return (
    <div
          ...
          <div className="sidebar-section-body d-flex justify-content-center">
            ...
            <div>
              <button
                ...
                type="button"
                className="btn btn-flat-white btn-icon btn-sm rounded-pill border-transparent sidebar-control sidebar-main-resize d-none d-lg-inline-flex text-white"
              >
              ...
              <button
                type="button"
                className="btn btn-flat-white btn-icon btn-sm rounded-pill border-transparent sidebar-mobile-main-toggle d-lg-none text-white"
              >
          ...
          <div className="nav nav-sidebar">
            <div className="nav-item">
              <Link
                to="/histories"
                className={`nav-link ${
                  path.pathname === "/histories" ? "active" : ""
                }`}
              >
            ...
            <div className="nav-item">
              <Link
                to="/favorites"
                className={`nav-link ${
                  path.pathname === "/favorites" ? "active" : ""
                }`}
              >
